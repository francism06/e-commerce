...
export const PrimaryButton = ({ label, location = null, action = null, CTA = false }) => {
    return (
        (
            location ?
                (<NavLink to={location} className={`${CTA && 'flex flex-row items-center gap-2'} w-fit px-8 py-1 bg-secondary border-2 border-black text-white font-bold  drop-shadow-primary 
                ...
                :
                (<button className={`${CTA && 'flex flex-row items-center gap-2'} w-fit px-8 py-1 bg-secondary border-2 border-black text-white font-bold  drop-shadow-primary 
...
export const SecondaryButton = ({ label, location = null, action = null, CTA = false }) => {
    return (
        (
            location ?
                (<NavLink to={location} className={`${CTA && 'flex flex-row items-center gap-2'} w-fit md:px-2 px-8 py-1 bg-white border-2 border-black  
                ...
                :
                (<button className={`${CTA && 'flex flex-row items-center gap-2'} w-fit px-8 py-1 bg-white border-2 border-black  
