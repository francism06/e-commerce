                    ...
                    <form onSubmit={handleSubmit} className="w-3/4 flex flex-col justify-center items-center gap-8">
                        ...
                        <div className="flex flex-col w-full gap-4">
                            <div className="flex flex-col w-full">
                                ...
                                <input onInput={(event) => setEmail(event.target.value)} className="input-field" type="text" name="email_address" id="email_address" autoComplete="email" />
                            </div>
                            <div className="flex flex-col w-full">
                                <label htmlFor="password">Password</label>
                                <input onInput={(event) => setPassword(event.target.value)} className="input-field" type="password" name="password" id="password" autoComplete="current-password" />
                            </div>
                        </div>
